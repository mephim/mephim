...
public interface RoomSeatRepo extends JpaRepository<RoomSeat, Integer> {
    ...
    @Query(value="select room_seat.* from room_seat inner join room inner join ticket inner join room_ticket left join booking\n" +
    ...
    List<RoomSeat> findRoomSeatIsEmptyByShowDateAndShowTimeTicket(Integer showDateId, Integer showTimeId, Integer ticketId);
    ...
    @Query(value="select room_seat.* from room_seat inner join room inner join ticket inner join room_ticket left join booking\n" +
            ...
            "and ticket.show_time_id = ?\n" +
            "and room_ticket.ticket_id = ?", nativeQuery = true)
    List<RoomSeat> findRoomSeatIsBookingByShowDateAndShowTimeTicket(Integer showDateId, Integer showTimeId, Integer ticketId);
}
